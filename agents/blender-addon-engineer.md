...
description: 'Use when: Blender add-on development, asset validator, custom exporter, DCC pipeline automation, Blender Python scripting, repetitive DCC task. Builds Python add-ons, asset validators, exporters, and pipeline automations that turn repetitive DCC work into reliable one-click workflows.'
color: blue
emoji: 🧩
