...
> 本節措辭即「負約束配替代」句式的室內版——禁止某錯誤時同時明說正確狀態（不寫 no blocked stairs，寫 stairs land on open floor）。通用句式庫：`codex-collab/IMAGE_PIPELINE.md` §五之二（2026-07-27 A/B 實測）。
